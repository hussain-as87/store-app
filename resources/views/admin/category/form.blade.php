...
<div class="tab-content" id="myTabContent">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="show" id="exampleRadios1" value="1" {{ $category->show == 1 ? 'checked' : '' }}>
        <label class="form-check-label" for="exampleRadios1">
            {{__('show')}}
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="show" id="exampleRadios2" value="0" {{ $category->show == 0 ? 'checked' : '' }}>
