            ...
            <div class="ps-section__header mb-50">
                ...
                <ul class="ps-masonry__filter">
                    ...
                    @foreach ($categories as $cat)
                        <li><a href="{{ route('grid.category',$cat->id) }}" data-filter=".{{$cat->name}}">{{$cat->name}}
                                <sup>1</sup></a></li>
                    @endforeach
                </ul>
            </div>
                                        ...
                                        <div class="ps-shoe__thumbnail">
                                            ...
                                            @if ($new_price!==null)
                                                <div class="ps-badge ps-badge--sale ps-badge--2nd">
                                                    <span>-{{ $formatter->format($new_price->percentage) }}</span></div>
                                            @endif
                                        ...
                                        <div class="ps-shoe__content">
                                            ...
                                            <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                                ...
                                                <p class="ps-shoe__categories"><a href="#">{{$pro->user->name}}</a>,<a
                                                        href="{{ route('grid.category',$pro->category->id) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                        <div class="ps-owl-actions"><a class="ps-prev" href="#"><i
                                    class="ps-icon-arrow-right"></i>{{__('Prev')}}</a><a class="ps-next"
                                                                                         href="#">{{__('Next')}}<i
                            ...
                            <div class="ps-shoe">
                                ...
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        ...
                                        @if(!empty($ra))
                                            <b class="p-2">( {{ $ra->rating }}
                                                <svg
                                                    class="bg-outline-warning cursor-pointer block w-8 h-8 @if($rating >= 5 ) text-warning @endif "
                                    ...
                                    <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                        ...
                                        <p class="ps-shoe__categories"><a
                                                href="{{ route('grid.category',$pro->category->id) }}">{{$pro->category->name}}</a>,<a
                                                href="#">
