            ...
            <div class="col-md-6 col-lg-5 p-b-30">
                <div class="p-r-50 p-t-5 p-lr-0-lg">
                    ...
                    <div class="flex-w flex-m p-l-100 p-t-40 respon7">
                        ...
                        @if($social->facebook != null) <a href="{{$social->facebook}}" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Facebook">
                            <i class="fa fa-facebook"></i>
                        </a>@endif
                        @if($social->instagram != null) <a href="{{$social->instagram}}" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="instagram">
                            <i class="fa fa-instagram"></i>
                        </a>@endif

                        @if($social->twitter != null) <a href="{{$social->twitter}}" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Twitter">
                            <i class="fa fa-twitter"></i>
                        </a>@endif

                        @if($social->google != null)<a href="{{$social->google}}" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="Google Plus">
                ...
                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            ...
                            <a href="{{route('store.product.show',$pro_c->id)}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
                                {{__('Quick View')}}
                            </a>
                        </div>
