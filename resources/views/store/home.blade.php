...
<section class="section-slide">
    <div class="wrap-slick1">
        <div class="slick1">
            ...
            <div class="item-slick1" style="background-image: url({{ asset('storage/advertis/' . $adv->photo) }});">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        ...
                        <div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
                            <a href="{{ route('store.shop') }}" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                                {{ __('Shop Now') }}
                            </a>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    ...
                    <a href="{{ route('store.shop') }}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
...
<section class="bg0 p-t-23 p-b-140">
    ...
    {{-- <div class="dis-none panel-search w-full p-t-10 p-b-15">
            <div class="bor8 dis-flex p-l-15">
                ...
                <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" wire:model.debounce.300ms="search"
    ...
    {{-- <div class="dis-none panel-filter w-full p-t-10">
            <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                <div class="filter-col1 p-r-15 p-b-27">
                    ...
                    <select class="form-select form-select-lg mb-3 p-b-6" aria-label=".form-select-lg example" wire:model="orderBy">
                    ...
                    <!--                    <ul>
                                            <li class="p-b-6">
                                                <a href="#" class="filter-link stext-106 trans-04  filter-link-active">
                                                    Default<input type="radio" value="id" wire:model="" class="filter-link stext-106 trans-04">
                                                </a>
                                            </li>
                                            <li class="p-b-6">
