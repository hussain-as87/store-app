                                ...
                                <div class="grid-item__content-wrapper">
                                    <div class="ps-shoe mb-30">
                                        <div class="ps-shoe__thumbnail">
                                            ...
                                            @endif
                                            <livewire:favorite-product-home :product="$pro">
                                        ...
                                        <div class="ps-shoe__content">
                                            ...
                                            <del>£{{$pro->price}}</del> £ {{$new_price->price}}</span>
                                                @else
                                                    <span class="ps-shoe__price">
                                            £ {{$pro->price}}</span>
                                                @endif
                                ...
                                <div class="ps-shoe__content">
                                    ...
                                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="{{route('store.product.show',$pro->id)}}">{{$pro->name}}</a>
                                        <p class="ps-shoe__categories"><a href="{{ route('grid.category',$pro->category->id) }}">{{$pro->category->name}}</a>,<a href="#">
                                                ...
                                                @endif
                                            </a>,<a href="#"> Jordan</a></p><span class="ps-shoe__price">
    ...
    <div class="ps-section ps-home-blog pt-80 pb-80">
        <div class="ps-container">
            <div class="ps-section__header mb-50">
                ...
                <div class="ps-section__action"><a class="ps-morelink text-uppercase" href="#">{{__('View all post')}}<i class="fa fa-long-arrow-right"></i></a></div>
            </div>
            <div class="ps-section__content">
                <div class="row">
                    {{--start section--}}
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            ...
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">An Inside
                                ...
                                <p class="ps-post__meta"><span>{{__('By')}}:<a class="mr-5" href="blog.html">Alena Studio</a></span>
                                    -<span class="ml-5">Jun 10, 2017</span></p>
                                <p>Leverage agile frameworks to provide a robust synopsis for high level overviews.
                                    Iterative approaches to corporate strategy foster collaborative thinking to
                                    further…</p><a class="ps-morelink" href="blog-detail.html">{{__('Read more')}}<i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            ...
                            <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.html">Unpacking
                                ...
                                <p>Leverage agile frameworks to provide a robust synopsis for high level overviews.
                                    Iterative approaches to corporate strategy foster collaborative thinking to
                                    further…</p><a class="ps-morelink" href="blog-detail.html">Read more<i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('images/blog/3.jpg')}}" alt=""></div>
