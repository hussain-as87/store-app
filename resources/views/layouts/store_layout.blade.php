    ...
    <header>
            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a class="flex-c-m trans-04 p-lr-25" href="{{ route('register') }}">{{ __('Sign up') }}</a>
                        @endif
                        @endif
                        ...
                        <a href="{{ route('change.language', __($key)) }}" class="flex-c-m trans-04 p-lr-25">{{ __($val['name']) }}
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="@auth
                        {{$item_count}}
                        @endauth">
                            <i class="zmdi zmdi-shopping-cart"></i>
                        </div>
                        <?php $fav_count = \App\Models\favoriteProduct::where('user_id', auth()->id())->count(); ?>
                        <a href="#" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="@auth
                        {{$fav_count}}
                       @endauth ">
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="wrap-icon-header flex-w flex-r-m m-r-15">
                ...
                <div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart" data-notify="@auth{{$item_count}} @endauth">
                    <i class="zmdi zmdi-shopping-cart"></i>
                </div>

                <a href="#" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti" data-notify="@auth{{$fav_count}} @endauth">
                    <i class="zmdi zmdi-favorite-outline"></i>
                </a>
            </div>
            ...
            <ul class="topbar-mobile">
                ...
                <li>
                    <div class="right-top-bar flex-w h-full">
                        ...
                        @if (Route::has('register'))
                        <a class="flex-c-m p-lr-10 trans-04" href="{{ route('register') }}">{{ __('Sign up') }}</a>
                        @endif
                        @endif
                        ...
                        @foreach (config('locales.languages') as $key => $val)
                        @if ($key != app()->getLocale())
                        <a href="{{ route('change.language', __($key)) }}" class="flex-c-m p-lr-10 trans-04">{{ __($val['name']) }}
                            <i class="flag-icon flag-icon-{{ __($val['icon']) }}" title="{{ $key }}" id="{{ $key }}"></i></a>
                        @endif
                        @endforeach
                    </div>
                        ...
                        <li class="header-cart-item flex-w flex-t m-b-12">
                            ...
                            <div class="header-cart-item-txt p-t-8">
                                ...
                                <span class="header-cart-item-info">
                                    {{$item['quantity']}} x ${{$item['price']}}= <b class="bg-auto">{{$item['price'] * $item['quantity']}}</b>
                                </span>
                            </div>
                        </li>
