...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('category-create')<a class="collapse-item" href="{{ route('categories.create') }}">{{ __('create') }}</a>@endcan
                        @can('category-trash')
                        <a class="collapse-item" href="{{ route('categories.trash') }}">{{ __('trash') }}</a>@endcan
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
                        <?php $category = new \App\Models\Admin\Category(); ?>
                        <a class="collapse-item" href="{{ route('subcategories.create') }}">{{ __('create subcategory') }}</a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#product" data-toggle="collapse" data-target="#product" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-folder"></i>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#user" data-toggle="collapse" data-target="#user" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>{{ __('users') }}</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#role" data-toggle="collapse" data-target="#role" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>{{ __('roles') }}</span>
                </a>
