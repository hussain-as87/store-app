                ...
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><img src="{{ asset('storage/category/' . $cat->photo) }}" alt="{{ $cat->name }}" style="width: 50px" /></td>
                                ...
                                @can('category-delete')
                                <td>
                                    <a class="btn btn-danger btn-circle" href="{{ route('categories.destroy', $cat->id) }}" onclick="return confirm('Are you sure?')">
